...
- Every change reaches the development branch through a reviewed pull request from its task branch. Nobody commits to the development or production branch directly. (Specs and designs under `specs/` and the architect's README.md updates are the exception: commit them to the development branch.)
